...
-(void)timerOn{
   ...
   NSTimer *timer = [NSTimer scheduledTimerWithTimeInterval:3.0f target:self selector:@selector(timerRunAction) userInfo:nil repeats:YES];
